...
class Registrar(Conexion):
    ...
    def registrar_usuario(self, dni, nombre, usuario, clave, rol, acceso, n_caja, ciudad, imagen):
        datos = (dni, nombre, usuario, clave, rol, acceso, n_caja, ciudad, imagen)
        sql = 'insert into usuarios(dni, nombre, usuario, clave, rol, acceso, n_caja, ciudad, imagen) values(%s,%s,%s,%s,%s,%s,%s,%s,%s)'
